  ...
  return (
    <div class="space-y-6 animate-fade-in">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="bg-orange-500 rounded-xl p-6 text-white shadow-lg shadow-orange-200 dark:shadow-none">
          <p class="text-orange-100 text-sm font-medium">{t.total_completions}</p>
